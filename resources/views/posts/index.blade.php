        ...
        <header class="flex items-center justify-between">
          <form class="w-10/12" action="{{route('posts.index')}}" method="GET" >
            ...
            <div class="flex items-center gap-3">
              <input class="focus:border-gray-500 focus:ring-1 focus:ring-gray-500 focus:outline-none w-full text-sm text-black placeholder-gray-500 border border-blue-700 rounded-md py-2 pl-10" placeholder="Filtrar propuestas de alquiler" name="texto" value="{{$texto}}" />
            ...
            <button type="submit" class="hover:bg-gray-700 hover:text-gray-200 h-10 flex bg-gray-800 text-gray-200 text-sm px-4 py-2 rounded-md ">        
              <a href="{{route('posts.index')}}">Limpiar</a>
            </button>
          ...
          <button class="hover:bg-gray-700 hover:text-gray-200 h-10 flex  bg-gray-800 text-gray-200 text-sm px-4 py-2 rounded-md  ">
            ...
            <svg class="group-hover:text-gray-600 text-green-400 mr-2 animate-pulse " width="12" height="20" fill="currentColor"  >
